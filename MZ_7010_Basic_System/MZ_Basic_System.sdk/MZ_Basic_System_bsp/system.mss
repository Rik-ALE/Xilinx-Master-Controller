...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = registers
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = registers_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = simple_axi_master
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = simple_axi_master_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vpattern_gen
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = vpattern_gen_0
END
