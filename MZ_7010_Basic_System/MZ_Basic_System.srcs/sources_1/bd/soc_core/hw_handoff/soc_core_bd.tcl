...
proc create_root_design { parentCell } {
  ...
  set VID_SEL [ create_bd_port -dir I VID_SEL ]
  ...
  set fake_irq [ create_bd_port -dir I -from 0 -to 0 fake_irq ]
  set regblock_in [ create_bd_port -dir I -from 31 -to 0 regblock_in ]
  set regblock_out [ create_bd_port -dir O -from 31 -to 0 regblock_out ]
  set regblock_wr [ create_bd_port -dir O regblock_wr ]
  ...
  set Video_Source_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Video_Source:1.0 Video_Source_0 ]
...
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets processing_system7_0_IIC_0]
  ...
  # Create port connections
  connect_bd_net -net Op1_1 [get_bd_ports fake_irq] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net VID_SEL_1 [get_bd_ports VID_SEL] [get_bd_pins Video_Source_0/SEL]
  connect_bd_net -net Video_Source_0_DATA_OUT [get_bd_pins Video_Source_0/DATA_OUT] [get_bd_pins ali3_serializer_0/video_data]
  connect_bd_net -net Video_Source_0_DE_OUT [get_bd_pins Video_Source_0/DE_OUT] [get_bd_pins ali3_serializer_0/video_de]
  connect_bd_net -net Video_Source_0_HSYNC_OUT [get_bd_pins Video_Source_0/HSYNC_OUT] [get_bd_pins ali3_serializer_0/video_hsync]
  connect_bd_net -net Video_Source_0_RST_OUT [get_bd_pins Video_Source_0/RST_OUT] [get_bd_pins ali3_serializer_0/reset_in]
  connect_bd_net -net Video_Source_0_VSYNC_OUT [get_bd_pins Video_Source_0/VSYNC_OUT] [get_bd_pins ali3_serializer_0/video_vsync]
  ...
  connect_bd_net -net in_reg1_1 [get_bd_ports regblock_in] [get_bd_pins registers_0/in_reg1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports clk33] [get_bd_pins Video_Source_0/CLK_IN] [get_bd_pins ali3_serializer_0/clk_in] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins rst_ps7_clk_video/slowest_sync_clk]
  ...
  connect_bd_net -net registers_0_out_reg4 [get_bd_ports regblock_out] [get_bd_pins registers_0/out_reg4]
  connect_bd_net -net registers_0_wr_reg3 [get_bd_ports strb_ctrl] [get_bd_pins registers_0/wr_reg3]
  connect_bd_net -net registers_0_wr_reg4 [get_bd_ports regblock_wr] [get_bd_pins registers_0/wr_reg4]
  ...
  connect_bd_net -net rst_ps7_clk_video_peripheral_reset [get_bd_pins Video_Source_0/RST_IN] [get_bd_pins rst_ps7_clk_video/peripheral_reset]
  ...
  connect_bd_net -net vpattern_gen_0_active_video_out [get_bd_pins Video_Source_0/DE_IN] [get_bd_pins vpattern_gen_0/active_video_out]
  connect_bd_net -net vpattern_gen_0_hsync_out [get_bd_pins Video_Source_0/HSYNC_IN] [get_bd_pins vpattern_gen_0/hsync_out]
  connect_bd_net -net vpattern_gen_0_video_out [get_bd_pins Video_Source_0/DATA_IN] [get_bd_pins vpattern_gen_0/video_out]
  connect_bd_net -net vpattern_gen_0_vsync_out [get_bd_pins Video_Source_0/VSYNC_IN] [get_bd_pins vpattern_gen_0/vsync_out]
...
#  -string -flagsOSRD
preplace port vhdl_irq -pg 1 -y -310 -defaultsOSRD
preplace port DDR -pg 1 -y 120 -defaultsOSRD
preplace port strb_ctrl -pg 1 -y -210 -defaultsOSRD
preplace port regblock_wr -pg 1 -y -180 -defaultsOSRD
preplace port clk100 -pg 1 -y 590 -defaultsOSRD
...
preplace port ALI_CLK_N -pg 1 -y 930 -defaultsOSRD
preplace port VID_SEL -pg 1 -y 1130 -defaultsOSRD
preplace port ALI_CLK_P -pg 1 -y 950 -defaultsOSRD
preplace port user_local_bus -pg 1 -y 80 -defaultsOSRD
preplace portBus debug -pg 1 -y 1720 -defaultsOSRD
preplace portBus ALI_DATA_P -pg 1 -y 990 -defaultsOSRD
preplace portBus status -pg 1 -y -280 -defaultsOSRD
preplace portBus ctrl -pg 1 -y -290 -defaultsOSRD
preplace portBus adr_source -pg 1 -y -350 -defaultsOSRD
preplace portBus regblock_out -pg 1 -y -270 -defaultsOSRD
preplace portBus fake_irq -pg 1 -y 510 -defaultsOSRD
preplace portBus reset_clk100 -pg 1 -y 720 -defaultsOSRD
preplace portBus regblock_in -pg 1 -y -260 -defaultsOSRD
preplace portBus size -pg 1 -y -310 -defaultsOSRD
preplace portBus adr_dest -pg 1 -y -330 -defaultsOSRD
preplace portBus ALI_DATA_N -pg 1 -y 970 -defaultsOSRD
...
preplace inst gnd -pg 1 -lvl 8 -y 1790 -defaultsOSRD
preplace inst Video_Source_0 -pg 1 -lvl 9 -y 1190 -defaultsOSRD
preplace inst vtiming_gen_0 -pg 1 -lvl 5 -y 1310 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 2 -y 510 -defaultsOSRD
preplace inst rst_ps7_clk_video -pg 1 -lvl 4 -y 1220 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 3 -y 730 -defaultsOSRD
preplace inst simple_axi_master_0 -pg 1 -lvl 2 -y 110 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 9 -y 1720 -defaultsOSRD
preplace inst rst_ps7_clk_axi_lite -pg 1 -lvl 4 -y 970 -defaultsOSRD
...
preplace inst ali3_serializer_0 -pg 1 -lvl 10 -y 930 -defaultsOSRD
...
preplace netloc axi_vdma_0_M_AXI_MM2S 1 2 1 880
preplace netloc in_reg1_1 1 0 2 NJ -260 NJ
preplace netloc antiglitch_0_signal_out 1 2 1 900
preplace netloc util_vector_logic_0_Res 1 2 1 850
preplace netloc processing_system7_0_FIXED_IO 1 4 7 NJ 170 NJ 170 NJ 170 NJ 170 NJ 170 NJ 170 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn1 1 2 4 NJ -10 NJ -10 1810 980 NJ
preplace netloc axi_vdma_0_M_AXIS_MM2S 1 2 4 NJ 850 NJ 850 NJ 850 N
preplace netloc xlconcat_1_dout 1 9 2 NJ 1720 N
preplace netloc Video_Source_0_HSYNC_OUT 1 9 1 3330
preplace netloc registers_0_out_irq0 1 2 1 NJ
preplace netloc vpattern_gen_0_video_out 1 7 2 N 940 3010
preplace netloc vcc1_dout 1 1 1 N
preplace netloc xlconcat_0_dout 1 3 1 NJ
preplace netloc Video_Source_0_DE_OUT 1 9 1 3290
preplace netloc vtiming_gen_0_vtiming_out_clone 1 5 2 NJ 800 NJ
preplace netloc processing_system7_0_FCLK_RESET1_N 1 3 2 1250 830 1760
preplace netloc processing_system7_0_DDR 1 4 7 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ
preplace netloc Video_Source_0_DATA_OUT 1 9 1 3300
preplace netloc ali3_serializer_0_ALI_DATA_N 1 10 1 N
preplace netloc registers_0_wr_reg3 1 2 9 NJ -210 NJ -210 NJ -210 NJ -210 NJ -210 NJ -210 NJ -210 NJ -210 NJ
preplace netloc Video_Source_0_RST_OUT 1 9 1 3340
preplace netloc registers_0_wr_reg4 1 2 9 NJ -180 NJ -180 NJ -180 NJ -180 NJ -180 NJ -180 NJ -180 NJ -180 NJ
preplace netloc user_dout 1 2 2 NJ 320 NJ
preplace netloc ali3_serializer_0_ALI_DATA_P 1 10 1 N
preplace netloc Op1_1 1 0 3 NJ 510 NJ 560 840
preplace netloc processing_system7_0_FCLK_RESET0_N 1 3 2 1260 -30 1760
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 5 2 NJ 420 2540
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 1 5 NJ -50 NJ -50 NJ -50 NJ -50 2190
preplace netloc in_irq0_1 1 0 2 NJ -310 NJ
preplace netloc vpattern_gen_0_vsync_out 1 7 2 NJ 920 3000
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn1 1 2 3 NJ 1480 NJ 1480 1750
preplace netloc axi_vdma_0_mm2s_introut 1 2 1 900
preplace netloc touch_irq_n_1 1 0 2 NJ 670 NJ
preplace netloc vtiming_gen_0_vtiming_out 1 5 1 2220
preplace netloc processing_system7_0_IIC_0 1 4 7 NJ 220 NJ 220 NJ 220 NJ 220 NJ 220 NJ 220 NJ
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 1 5 NJ -120 NJ -120 NJ -120 NJ -120 2200
preplace netloc processing_system7_0_FCLK_CLK0 1 1 10 NJ 10 NJ 10 1240 0 1830 590 NJ 590 NJ 590 NJ 590 NJ 590 NJ 590 NJ
preplace netloc processing_system7_0_FCLK_CLK1 1 3 8 1280 840 1770 750 NJ 750 NJ 750 NJ 750 NJ 770 NJ 770 NJ
preplace netloc processing_system7_0_FCLK_CLK2 1 1 5 NJ 610 NJ 610 1230 20 1780 620 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 3 890 -40 NJ -40 1800
preplace netloc vcc_dout 1 5 1 2230
preplace netloc Video_Source_0_VSYNC_OUT 1 9 1 3320
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 1 5 NJ -70 NJ -70 NJ -70 NJ -70 2180
preplace netloc cache_dout 1 2 2 NJ 290 NJ
preplace netloc ali3_serializer_0_clk_out 1 4 7 1830 990 NJ 790 NJ 800 NJ 800 NJ 800 N 800 3660
preplace netloc ali3_serializer_0_reset_out 1 4 7 1840 1010 NJ 770 NJ 810 NJ 810 NJ 810 N 810 3650
preplace netloc v_axi4s_vid_out_0_vtg_ce 1 4 3 1840 1380 NJ 1380 2480
preplace netloc ali3_serializer_0_ALI_CLK_N 1 10 1 N
preplace netloc simple_axi_master_0_M00_AXI 1 2 1 NJ
preplace netloc axi_mem_intercon_1_M00_AXI 1 3 1 N
preplace netloc in_reg0_1 1 0 2 NJ -280 NJ
preplace netloc registers_0_out_reg0 1 2 9 NJ -350 NJ -350 NJ -350 NJ -350 NJ -350 NJ -350 NJ -350 NJ -350 NJ
preplace netloc ali3_serializer_0_ALI_CLK_P 1 10 1 N
preplace netloc processing_system7_0_M_AXI_GP0 1 4 1 1770
preplace netloc vpattern_gen_0_active_video_out 1 7 2 NJ 900 3020
preplace netloc rst_ps7_clk_axi_lite_peripheral_reset 1 4 7 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ 720 NJ
preplace netloc registers_0_out_reg1 1 2 9 NJ -330 NJ -330 NJ -330 NJ -330 NJ -330 NJ -330 NJ -330 NJ -330 NJ
preplace netloc registers_0_out_reg2 1 2 9 NJ -310 NJ -310 NJ -310 NJ -310 NJ -310 NJ -310 NJ -310 NJ -310 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 N
preplace netloc registers_0_out_reg3 1 2 9 NJ -290 NJ -290 NJ -290 NJ -290 NJ -290 NJ -290 NJ -290 NJ -290 NJ
preplace netloc user_local_bus_1 1 0 2 NJ 80 NJ
preplace netloc registers_0_out_reg4 1 2 9 N -270 NJ -270 NJ -270 NJ -270 NJ -270 NJ -270 NJ -270 NJ -270 NJ
preplace netloc vpattern_gen_0_hsync_out 1 7 2 NJ 960 2990
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 6 NJ -20 NJ -20 NJ -20 1790 760 NJ 760 NJ
preplace netloc gnd_dout 1 2 7 920 1650 NJ 1650 NJ 1650 NJ 1650 NJ 1650 NJ 1650 3010
preplace netloc VID_SEL_1 1 0 9 NJ 1130 NJ 1130 NJ 1130 NJ 1130 NJ 1130 NJ 1130 NJ 1130 NJ 1130 2980
preplace netloc rst_ps7_clk_video_peripheral_reset 1 4 5 NJ 1210 NJ 1210 NJ 1210 NJ 1210 N
preplace netloc processing_system7_0_FCLK_RESET2_N 1 3 2 1270 860 1750
preplace netloc v_axi4s_vid_out_0_vid_io_out 1 6 1 NJ
levelinfo -pg 1 -90 190 680 1070 1520 2030 2360 2690 2920 3160 3510 3680 -top -400 -bot 1840
",
}
