...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="LATCH,EQ00001,ISDATA,DIN_EN,SIN,LATCHBIT" />
        <signal name="TP(5:0)" />
        <signal name="EDGE150" />
        <signal name="SEL(1)" />
        <signal name="SEL(0)" />
        ...
        <block symbolname="buf" name="XLXI_273(5:0)">
            <blockpin signalname="LATCH,EQ00001,ISDATA,DIN_EN,SIN,LATCHBIT" name="I" />
    ...
    <sheet sheetnum="1" width="3801" height="2688">
        ...
        <text style="fontsize:48;fontname:Arial" x="3264" y="2532">SERIN_POLLED</text>
        ...
        <branch name="LATCH,EQ00001,ISDATA,DIN_EN,SIN,LATCHBIT">
        ...
        <text style="fontsize:24;fontname:Arial" x="104" y="548">400ns/BIT 2000ns.WORD OMNIDOT -] TZDB (CLK=25M, SEL(10) -] SELX)</text>
        <text style="fontsize:24;fontname:Arial" x="108" y="520">62.5ns/BIT 312.5ns K-SERIES -] TZDB (CLK=100M, SEL(5) -] SELX)</text>
        ...
        <text style="fontsize:24;fontname:Arial" x="56" y="2204">LSB 1ST. THE IDLE '1' COMES 1ST</text>
    </sheet>
</drawing>