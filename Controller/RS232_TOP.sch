...
<drawing version="7">
    ...
    <netlist>
        ...
        <port polarity="Input" name="RX_GATE" />
        <blockdef name="gnd">
        ...
        <blockdef name="RS232_TOP_TX">
            <timestamp>2018-2-2T3:23:40</timestamp>
        ...
        <block symbolname="RS232_TOP_TX" name="XLXI_TOP_TX">
            <blockpin signalname="TCBAUDX2" name="BAUDX2_EN" />
            <blockpin signalname="CLK48M" name="CLK" />
            ...
            <blockpin signalname="TXEMPTY" name="TXEMPTY" />
            <blockpin signalname="TXERR" name="TXERR" />
            <blockpin signalname="TXFULL" name="TXFULL" />
            <blockpin signalname="TX_EN" name="TX_EN" />
        </block>
        <block symbolname="RS232_TOP_RX2" name="RS232_TOPRX2">
            ...
            <blockpin signalname="RXREQEN" name="RXREQ_EN" />
            <blockpin name="TP(7:0)" />
        </block>
        <block symbolname="fd" name="XLXI_1668">
            <blockpin signalname="CLK48M" name="C" />
            <blockpin signalname="RX_GATE" name="D" />
            <blockpin signalname="RXREQEN" name="Q" />
        </block>
        <block symbolname="RS232_BAUD" name="XLXI_1669">
            <blockpin signalname="TCBAUDX2" name="BAUDX2" />
            <blockpin signalname="TCBAUDX4" name="BAUDX4" />
            <blockpin signalname="CLK48M" name="CLK48M" />
            <blockpin signalname="DIV(2:0)" name="DIV(2:0)" />
            <blockpin signalname="DIV12" name="DIV12" />
            <blockpin signalname="RSTn" name="RSTn" />
        </block>
    </netlist>
    <sheet sheetnum="1" width="3801" height="2688">
        ...
        <text style="alignment:CENTER;fontsize:44;fontname:Arial" x="3520" y="2496">RS232_TOP</text>
        ...
        <branch name="TCBAUDX2">
            ...
            <wire x2="2720" y1="320" y2="320" x1="2656" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="2596" y="284">BAUDRATE x 2</text>
        <branch name="TX(7:0)">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="2656" y="384" type="branch" />
            <wire x2="2720" y1="384" y2="384" x1="2656" />
        </branch>
        <branch name="TX_EN">
        ...
        <branch name="TXD">
            <wire x2="3280" y1="192" y2="192" x1="3168" />
        </branch>
        <iomarker fontsize="28" x="3280" y="192" name="TXD" orien="R0" />
        <branch name="TXEMPTY">
            <wire x2="3232" y1="256" y2="256" x1="3168" />
        </branch>
        <iomarker fontsize="28" x="3232" y="256" name="TXEMPTY" orien="R0" />
        <text style="fontsize:24;fontname:Arial" x="3412" y="252">TX FIFO EMPTY</text>
        <text style="fontsize:24;fontname:Arial" x="3404" y="184">TX TO DEVICE (DEFAULTS HI)</text>
        <text style="fontsize:24;fontname:Arial" x="3204" y="736">FROM DEVICE TO HOST CPU</text>
        <branch name="RXREQEN">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="2672" y="1024" type="branch" />
            <wire x2="2720" y1="1024" y2="1024" x1="2672" />
        </branch>
        <branch name="RXD">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="2672" y="960" type="branch" />
        ...
        <branch name="TCBAUDX4">
            ...
            <wire x2="2720" y1="896" y2="896" x1="2672" />
        </branch>
        <branch name="CLK48M">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="2672" y="832" type="branch" />
            <wire x2="2720" y1="832" y2="832" x1="2672" />
        </branch>
        <branch name="RSTn">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="2672" y="768" type="branch" />
            <wire x2="2720" y1="768" y2="768" x1="2672" />
        </branch>
        <iomarker fontsize="28" x="3264" y="768" name="RX(7:0)" orien="R0" />
        <rect width="1264" x="2508" y="48" height="536" />
        <rect width="1208" x="2500" y="624" height="520" />
        <branch name="RXD">
            ...
            <wire x2="400" y1="496" y2="496" x1="304" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="180" y="448">RX FROM DEVICE (DEFAULTS HI)</text>
        <text style="fontsize:24;fontname:Arial" x="168" y="544">(IOD IN PARENT MODULE)</text>
        <text style="fontsize:24;fontname:Arial" x="260" y="608">HOST REQUESTS NEXT BYTE. DATA IF RX() NON-ZERO.</text>
        <branch name="RX_GATE">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="432" y="656" type="branch" />
            <wire x2="432" y1="656" y2="656" x1="352" />
        </branch>
        <iomarker fontsize="28" x="288" y="496" name="RXD" orien="R180" />
        <iomarker fontsize="28" x="352" y="656" name="RX_GATE" orien="R180" />
        <branch name="RTS">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="352" y="784" type="branch" />
            <wire x2="352" y1="784" y2="784" x1="272" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="212" y="744">FROM DEVICE - OK TO TXD WHEN HIGH</text>
        <iomarker fontsize="28" x="272" y="784" name="RTS" orien="R180" />
        <branch name="TXERR">
            <wire x2="3264" y1="384" y2="384" x1="3168" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="3416" y="388">TX FIFO OVERFLOW</text>
        <iomarker fontsize="28" x="3264" y="384" name="TXERR" orien="R0" />
        <branch name="TXFULL">
            <wire x2="3184" y1="320" y2="320" x1="3168" />
            <wire x2="3264" y1="320" y2="320" x1="3184" />
        </branch>
        <iomarker fontsize="28" x="3264" y="320" name="TXFULL" orien="R0" />
        ...
        <text style="fontsize:24;fontname:Arial" x="2544" y="132">1x RAMB16</text>
        <text style="fontsize:24;fontname:Arial" x="2568" y="708">1x RAMB16</text>
        <instance x="2720" y="544" name="XLXI_TOP_TX" orien="R0">
        </instance>
        <instance x="2720" y="1056" name="RS232_TOPRX2" orien="R0">
        </instance>
        <branch name="RX(7:0)">
            <wire x2="3264" y1="768" y2="768" x1="3168" />
        </branch>
        <branch name="RXEMPTY">
            <wire x2="3232" y1="832" y2="832" x1="3168" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="3420" y="832">RX FIFO EMPTY</text>
        <branch name="RXFULL">
            <wire x2="3248" y1="896" y2="896" x1="3168" />
        </branch>
        <branch name="RXERR">
            <wire x2="3184" y1="960" y2="960" x1="3168" />
            <wire x2="3264" y1="960" y2="960" x1="3184" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="3432" y="956">RX FIFO OVERFLOW</text>
        <iomarker fontsize="28" x="3232" y="832" name="RXEMPTY" orien="R0" />
        <iomarker fontsize="28" x="3248" y="896" name="RXFULL" orien="R0" />
        <iomarker fontsize="28" x="3264" y="960" name="RXERR" orien="R0" />
        <text style="fontsize:24;fontname:Arial" x="1448" y="2332">0.15% ACCURATE</text>
        <branch name="RX_GATE">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="1248" y="192" type="branch" />
            <wire x2="1312" y1="192" y2="192" x1="1248" />
        </branch>
        <branch name="CLK48M">
        ...
        <branch name="RXREQEN">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="1744" y="192" type="branch" />
            <wire x2="1744" y1="192" y2="192" x1="1696" />
        </branch>
        <text style="fontsize:24;fontname:Arial" x="1624" y="108">PER CHANNEL- TO PRELOAD NEXT BYTE</text>
        <instance x="1312" y="448" name="XLXI_1668" orien="R0" />
        <branch name="RSTn">
        ...
        <branch name="DIV12">
            ...
            <wire x2="1488" y1="768" y2="768" x1="1424" />
        </branch>
        <branch name="DIV(2:0)">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="1424" y="832" type="branch" />
            <wire x2="1488" y1="832" y2="832" x1="1424" />
        </branch>
        <instance x="1488" y="864" name="XLXI_1669" orien="R0">
        </instance>
        <text style="fontsize:24;fontname:Arial" x="1392" y="500">SELECT RATE</text>
        <branch name="TCBAUDX4">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="1920" y="640" type="branch" />
            <wire x2="1920" y1="640" y2="640" x1="1872" />
        </branch>
        <branch name="TCBAUDX2">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="1920" y="704" type="branch" />
            <wire x2="1920" y1="704" y2="704" x1="1872" />
        </branch>
        <rect width="832" x="1272" y="452" height="452" />
        <text style="fontsize:32;fontname:Arial" x="2884" y="1428">***DELETE***</text>
        <text style="fontsize:32;fontname:Arial" x="1944" y="1840">***DELETE***</text>
        <text style="fontsize:32;fontname:Arial" x="1436" y="2008">***DELETE***</text>
        <text style="fontsize:32;fontname:Arial" x="112" y="896">***DELETE***</text>
    </sheet>
</drawing>