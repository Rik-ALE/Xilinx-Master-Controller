...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="EQ2" />
        <signal name="EQ3" />
        <signal name="LX(4:0),CMP2(10:0)" />
        <signal name="LX(4:0),CMP3(10:0)" />
        <signal name="VAL(10:0)" />
        <signal name="CMP(10:0)" />
        <signal name="CMP1(15:0)" />
        <signal name="CMP2(15:0)" />
        <signal name="CMP3(15:0)" />
        <signal name="LX(4:0),CMP1(10:0)" />
        <signal name="LX(5:0)" />
        <signal name="OFF3(10:0)" />
        <signal name="OFF2(10:0)" />
        <signal name="OFF1(10:0)" />
        <signal name="LX(4:0),OFF1(10:0)" />
        <signal name="LX(4:0),OFF2(10:0)" />
        <signal name="LX(4:0),OFF3(10:0)" />
        <signal name="LX(4:0),CMP(10:0)" />
        <signal name="LX(4:0),VAL(10:0)" />
        <port polarity="Output" name="EQ" />
        <port polarity="Output" name="EQ1" />
        <port polarity="Output" name="EQ2" />
        <port polarity="Output" name="EQ3" />
        <port polarity="Input" name="VAL(10:0)" />
        <port polarity="Input" name="CMP(10:0)" />
        <port polarity="Input" name="OFF3(10:0)" />
        <port polarity="Input" name="OFF2(10:0)" />
        <port polarity="Input" name="OFF1(10:0)" />
        ...
        <block symbolname="comp16" name="XLXI_881">
            <blockpin signalname="LX(4:0),VAL(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),CMP(10:0)" name="B(15:0)" />
            <blockpin signalname="EQ" name="EQ" />
        </block>
        <block symbolname="comp16" name="XLXI_947">
            <blockpin signalname="LX(4:0),VAL(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),CMP1(10:0)" name="B(15:0)" />
            <blockpin signalname="EQ1" name="EQ" />
        </block>
        <block symbolname="add16" name="XLXI_949">
            <blockpin signalname="LX(4:0),CMP(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),OFF1(10:0)" name="B(15:0)" />
        ...
        <block symbolname="add16" name="XLXI_1151">
            <blockpin signalname="LX(4:0),CMP(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),OFF2(10:0)" name="B(15:0)" />
            <blockpin signalname="L" name="CI" />
            <blockpin name="CO" />
            <blockpin name="OFL" />
        ...
        <block symbolname="add16" name="XLXI_1152">
            <blockpin signalname="LX(4:0),CMP(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),OFF3(10:0)" name="B(15:0)" />
            <blockpin signalname="L" name="CI" />
            <blockpin name="CO" />
            <blockpin name="OFL" />
        ...
        <block symbolname="comp16" name="XLXI_1154">
            <blockpin signalname="LX(4:0),VAL(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),CMP2(10:0)" name="B(15:0)" />
            <blockpin signalname="EQ2" name="EQ" />
        </block>
        <block symbolname="comp16" name="XLXI_1155">
            <blockpin signalname="LX(4:0),VAL(10:0)" name="A(15:0)" />
            <blockpin signalname="LX(4:0),CMP3(10:0)" name="B(15:0)" />
            <blockpin signalname="EQ3" name="EQ" />
        </block>
        <block symbolname="buf" name="XLXI_1156(5:0)">
            <blockpin signalname="L" name="I" />
            <blockpin signalname="LX(5:0)" name="O" />
        </block>
    </netlist>
    <sheet sheetnum="1" width="3801" height="2688">
        ...
        <text style="alignment:CENTER;fontsize:44;fontname:Arial" x="3520" y="2616">29/01/15  (C) ALE</text>
        <text style="alignment:CENTER;fontsize:24;fontname:Arial" x="3516" y="2572">COMPARE VALUE WITH OFFSETS</text>
        <text style="alignment:CENTER;fontsize:44;fontname:Arial" x="3528" y="2516">CompDelta11</text>
        <branch name="VAL(10:0)">
        ...
        <iomarker fontsize="28" x="288" y="96" name="VAL(10:0)" orien="R180" />
        <branch name="CMP(10:0)">
        ...
        <iomarker fontsize="28" x="288" y="160" name="CMP(10:0)" orien="R180" />
        <branch name="LX(4:0),VAL(10:0)">
        ...
        <instance x="1872" y="2400" name="XLXI_1156(5:0)" orien="R0" />
        <branch name="LX(5:0)">
            <attrtext style="alignment:SOFT-LEFT;fontsize:28;fontname:Arial" attrname="Name" x="2160" y="2368" type="branch" />
            <wire x2="2160" y1="2368" y2="2368" x1="2096" />
        </branch>
        <iomarker fontsize="28" x="304" y="384" name="OFF3(10:0)" orien="R180" />
        <iomarker fontsize="28" x="304" y="304" name="OFF2(10:0)" orien="R180" />
        <iomarker fontsize="28" x="304" y="224" name="OFF1(10:0)" orien="R180" />
        <branch name="OFF3(10:0)">
        ...
        <branch name="L">
            <attrtext style="alignment:SOFT-RIGHT;fontsize:28;fontname:Arial" attrname="Name" x="1840" y="2368" type="branch" />
            <wire x2="1872" y1="2368" y2="2368" x1="1840" />
        </branch>
        <branch name="LX(4:0),OFF1(10:0)">
